package cn.wuyi.payment.channel.alipay;
...
public class AlipayConfig extends BaseClass{
    ...
    //private String notify_url = "http://xxpay.nat100.top/notify/pay/aliPayNotifyRes.htm";
    ...
    public String getNotify_url() {
    	return getConfig("matrix-payment.alipay_notify_url_" + getConfig("matrix-core.model"));
    }
